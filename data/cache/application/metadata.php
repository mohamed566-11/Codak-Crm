...
return [
  'aclDefs' => [
    ...
    'Pipeline' => [
      'accessCheckerClassName' => 'Espo\\Classes\\Acl\\Pipeline\\AccessChecker',
      'portalAccessCheckerClassName' => 'Espo\\Classes\\AclPortal\\Pipeline\\AccessChecker'
    ],
    'PipelineStage' => [
      'accessCheckerClassName' => 'Espo\\Classes\\Acl\\PipelineStage\\AccessChecker',
      'portalAccessCheckerClassName' => 'Espo\\Classes\\AclPortal\\PipelineStage\\AccessChecker'
    ],
    'Portal' => [
  ...
  'app' => [
    ...
    'appParams' => [
      ...
      'pipelines' => [
        'className' => 'Espo\\Classes\\AppParams\\Pipelines'
      ],
      'meetingServices' => [
    ...
    'client' => [
      ...
      'cssList' => [
        0 => 'client/custom/css/custom-logo.css',
        1 => 'client/custom/css/custom-brand.css',
        2 => 'client/custom/css/custom-ui-animations.css'
      ]
    ],
    'clientIcons' => [
      'classList' => []
    ...
    'consoleCommands' => [
      ...
      'populateScheduledJobs' => [
        'className' => 'Espo\\Classes\\ConsoleCommands\\PopulateScheduledJobs',
        'listed' => true,
        'allowedFlags' => [],
        'allowedOptions' => []
      ],
      ...
      'config:get' => [
        'className' => 'Espo\\Classes\\ConsoleCommands\\GetConfigParam',
        'listed' => true,
        'allowedFlags' => [
          0 => 'json'
        ],
      ...
      'config:set' => [
        'className' => 'Espo\\Classes\\ConsoleCommands\\SetConfigParam',
        'listed' => true,
        'allowedOptions' => [
          0 => 'type'
        ],
      ...
      'config:populate' => [
        'className' => 'Espo\\Classes\\ConsoleCommands\\ConfigPopulate',
        'listed' => true,
        'allowedOptions' => [],
        'allowedFlags' => [],
        'noSystemUser' => true
      ...
      'db:check' => [
        'className' => 'Espo\\Classes\\ConsoleCommands\\DbCheck',
        'listed' => true,
        'noSystemUser' => true
      ],
      'appCheck' => [
        'className' => 'Espo\\Classes\\ConsoleCommands\\AppCheck',
        'listed' => true,
        'noSystemUser' => true
      ],
      'migrate' => [
    ...
    'entityManager' => [
      ...
      'deleteHookClassNameList' => [
        ...
        3 => 'Espo\\Tools\\EntityManager\\Hook\\Hooks\\CategoriesDeleteHook'
      ],
      'beforeUpdateHookClassNameList' => [
        0 => 'Espo\\Tools\\EntityManager\\Hook\\Hooks\\CategoriesBeforeUpdateHook',
        1 => 'Espo\\Tools\\EntityManager\\Hook\\Hooks\\PipelinesBeforeUpdateHook'
      ],
      'updateHookClassNameList' => [
        ...
        3 => 'Espo\\Tools\\EntityManager\\Hook\\Hooks\\CategoriesUpdateHook',
        4 => 'Espo\\Tools\\EntityManager\\Hook\\Hooks\\LockableUpdateHook',
        5 => 'Espo\\Tools\\EntityManager\\Hook\\Hooks\\PipelinesUpdateHook'
      ]
    ],
    'entityManagerParams' => [
      'Global' => [
    ...
    'metadata' => [
      ...
      'additionalBuilderClassNameList' => [
        ...
        5 => 'Espo\\Core\\Utils\\Metadata\\AdditionalBuilder\\Pipelines',
        6 => 'Espo\\Core\\Utils\\Metadata\\AdditionalBuilder\\LogicDefsBc'
      ],
      'aclDependencies' => []
    ],
    'orm' => [
    ...
    'record' => [
      ...
      'beforeCreateHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Common\\Lock\\BeforeSaveValidation'
      ],
      'beforeUpdateHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Common\\Lock\\BeforeSaveValidation'
      ],
      'beforeDeleteHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Common\\Lock\\BeforeDeleteValidation'
      ]
    ],
    'recordId' => [
      'length' => 17
  ...
  'clientDefs' => [
    ...
    'EmailAccount' => [
      ...
      'detailActionList' => [
        0 => [
          ...
          'label' => 'Reset',
          'acl' => 'edit',
          'handler' => 'handlers/email-account/reset-fetch-data-action',
          'actionFunction' => 'process'
        ]
      ],
      'relationshipPanels' => [
    ...
    'Global' => [
      ...
      'viewSetupHandlers' => [
        'record/detail' => [
          0 => 'handlers/record/lock-view-setup',
          1 => 'handlers/record/pipeline-view-setup'
        ],
        'record/edit' => [
          0 => 'handlers/record/lock-view-setup',
          1 => 'handlers/record/pipeline-view-setup'
    ...
    'LeadCapture' => [
      ...
      'viewSetupHandlers' => [
        'record/detail' => [
          0 => 'handlers/lead-capture/record-detail-view-setup'
        ],
        'record/edit' => [
          0 => 'handlers/lead-capture/record-detail-view-setup'
        ]
      ...
      'relationshipPanels' => [
        ...
        'pipeline' => [
          'selectHandler' => 'handlers/lead-capture/pipeline-select-handler'
        ]
      ]
    ],
    ...
    'Pipeline' => [
      ...
      'views' => [
        'detail' => 'views/pipeline/detail'
      ],
      'rowActionDefs' => [
        'moveUp' => [
          'label' => 'Move Up',
          'groupIndex' => 3,
          'handler' => 'handlers/pipeline/move-row-action',
          'acl' => 'edit',
      ...
      'relationshipPanels' => [
        'stages' => [
          'view' => 'views/pipeline/record/panels/stages',
          'selectDisabled' => true,
          'unlinkDisabled' => true,
          'layout' => 'listForPipeline',
          'rowActionList' => [
            0 => 'moveUp',
            1 => 'moveDown'
          ],
    ...
    'PipelineStage' => [
      ...
      'rowActionDefs' => [
        'moveUp' => [
          'label' => 'Move Up',
          'groupIndex' => 3,
          'handler' => 'handlers/pipeline-stage/move-row-action',
          'iconClass' => 'fas fa-arrow-up'
        ],
        'moveDown' => [
          'label' => 'Move Down',
    ...
    'Account' => [
      ...
      'recordViews' => [
        ...
        'edit' => 'custom:views/account/record/edit',
    ...
    'Campaign' => [
      ...
      'recordViews' => [
        'detail' => 'custom:views/campaign/record/detail',
        'edit' => 'custom:views/campaign/record/edit',
        'list' => 'custom:views/campaign/record/list'
      ],
      'views' => [
    ...
    'Case' => [
      ...
      'recordViews' => [
        ...
        'edit' => 'custom:views/case/record/edit',
        'list' => 'custom:views/case/record/list'
      ],
      'detailActionList' => [
        0 => [
          'name' => 'close',
    ...
    'Contact' => [
      ...
      'recordViews' => [
        ...
        'edit' => 'custom:views/contact/record/edit',
    ...
    'Lead' => [
      ...
      'recordViews' => [
        'detail' => 'custom:views/lead/record/detail',
        'edit' => 'custom:views/lead/record/edit',
    ...
    'Meeting' => [
      ...
      'recordViews' => [
        'list' => 'custom:views/meeting/record/list',
        'detail' => 'custom:views/meeting/record/detail',
        'editSmall' => 'crm:views/meeting/record/edit-small',
        'edit' => 'custom:views/meeting/record/edit'
      ],
      'modalViews' => [
        'detail' => 'crm:views/meeting/modals/detail'
      ],
      'viewSetupHandlers' => [
        'record/detail' => [
          0 => 'crm:handlers/event/reminders-handler',
          1 => 'modules/crm/handlers/meeting/external-service'
        ],
        'record/edit' => [
          0 => 'crm:handlers/event/reminders-handler',
          1 => 'modules/crm/handlers/meeting/external-service'
    ...
    'TargetList' => [
      ...
      'recordViews' => [
        ...
        'edit' => 'custom:views/target-list/record/edit',
        'list' => 'custom:views/target-list/record/list'
      ],
      'modalViews' => [
        'select' => 'views/modals/select-records-with-categories'
      ],
    ...
    'Task' => [
      ...
      'modalDetailActionList' => [
        0 => [
          'name' => 'complete',
          'labelTranslation' => 'Task.labels.Complete',
          'acl' => 'edit',
          ...
          0 => [
            'rows' => [
              ...
              2 => [
                0 => [
                  'name' => 'orderBy',
                  'labelTranslation' => 'DashletOptions.fields.sortBy'
                ],
                1 => [
                  'name' => 'order',
                  'labelTranslation' => 'DashletOptions.fields.sortDirection'
                ]
              ],
              3 => [
                0 => [
    ...
    'LeadCapture' => [
      'fields' => [
        ...
        'pipeline' => [
          'type' => 'link',
          'validatorClassNameList' => [
            0 => 'Espo\\Classes\\FieldValidators\\LeadCapture\\Pipeline\\Valid'
          ],
    ...
    'Pipeline' => [
      'fields' => [
        ...
        'entityType' => [
          ...
          'required' => true,
          'readOnlyAfterCreate' => true,
          'view' => 'views/pipeline/fields/entity-type',
          'validatorClassNameList' => [
            0 => 'Espo\\Classes\\FieldValidators\\Pipeline\\EntityType\\Valid'
          ]
        ],
        'field' => [
          'type' => 'enum',
          ...
          'readOnly' => true,
          'validatorClassNameList' => [
            0 => 'Espo\\Classes\\FieldValidators\\Pipeline\\Field\\Valid'
          ],
          'view' => 'views/pipeline/fields/field'
        ],
        'color' => [
          'type' => 'int',
          'min' => 0,
          'max' => 8,
          'view' => 'views/fields/color'
        ],
        'isAvailableForAll' => [
          'type' => 'bool',
          'default' => true
    ...
    'PipelineStage' => [
      'fields' => [
        ...
        'mappedStatus' => [
          ...
          'readOnlyAfterCreate' => true,
          'required' => true,
          'view' => 'views/pipeline-stage/fields/mapped-status',
          'validatorClassNameList' => [
            0 => 'Espo\\Classes\\FieldValidators\\PipelineStatus\\MappedStatus\\Valid'
          ]
        ],
        'entityType' => [
          'type' => 'foreign',
    ...
    'Case' => [
      'fields' => [
        ...
        'collaborators' => [
          ...
          'fieldManagerParamList' => [
            0 => 'readOnly',
            1 => 'readOnlyAfterCreate',
            2 => 'audited',
            3 => 'autocompleteOnEmpty',
            4 => 'maxCount',
            5 => 'inlineEditDisabled',
            6 => 'tooltipText'
          ],
          'dynamicLogicVisibleDisabled' => true
        ],
    ...
    'Meeting' => [
      'fields' => [
        ...
        'externalService' => [
          ...
          'isSorted' => true,
          'validatorClassNameList' => [
            0 => 'Espo\\Modules\\Crm\\Classes\\FieldValidators\\Meeting\\ExternalService\\Valid'
          ],
  ...
  'fields' => [
    ...
    'link' => [
      ...
      'validatorClassNameMap' => [
        'cascadingSelect' => 'Espo\\Classes\\FieldValidators\\Common\\Link\\CascadingSelect'
      ],
      'filter' => true,
      'notCreatable' => true,
    ...
    'linkMultiple' => [
      ...
      'validatorClassNameMap' => [
        'cascadingSelect' => 'Espo\\Classes\\FieldValidators\\Common\\LinkMultiple\\CascadingSelect'
      ],
      'notCreatable' => true,
      'notSortable' => true,
      'filter' => true,
  ...
  'recordDefs' => [
    ...
    'LeadCapture' => [
      ...
      'createInputFilterClassNameList' => [
        0 => 'Espo\\Classes\\Record\\LeadCapture\\InputFilter'
      ],
      'updateInputFilterClassNameList' => [
        0 => 'Espo\\Classes\\Record\\LeadCapture\\InputFilter'
      ],
    ...
    'Pipeline' => [
      'beforeDeleteHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Hooks\\Pipeline\\BeforeDelete'
      ],
      'afterCreateHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Hooks\\Pipeline\\AfterSave'
      ],
      'afterUpdateHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Hooks\\Pipeline\\AfterSave'
      ],
      'afterDeleteHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Hooks\\Pipeline\\AfterDelete'
      ],
      'massActions' => [
        'delete' => [
          'disabled' => true
    ...
    'PipelineStage' => [
      'beforeDeleteHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Hooks\\PipelineStage\\BeforeDelete'
      ],
      'afterCreateHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Hooks\\PipelineStage\\AfterSave'
      ],
      'afterUpdateHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Hooks\\PipelineStage\\AfterSave'
      ],
      'afterDeleteHookClassNameList' => [
        0 => 'Espo\\Classes\\Record\\Hooks\\PipelineStage\\AfterDelete'
      ],
      'massActions' => [
        'delete' => [
          'disabled' => true
    ...
    'Meeting' => [
      ...
      'earlyBeforeCreateHookClassNameList' => [
        0 => 'Espo\\Modules\\Crm\\Classes\\RecordHooks\\Meeting\\BeforeCreateExternalServiceCheck'
      ],
      'beforeCreateHookClassNameList' => [
  ...
  'selectDefs' => [
    ...
    'Pipeline' => [
      'primaryFilterClassNameMap' => [
        'active' => 'Espo\\Classes\\Select\\Pipeline\\PrimaryFilters\\Active'
      ],
      'accessControlFilterClassNameMap' => [
        'mandatory' => 'Espo\\Classes\\Select\\Pipeline\\AccessControlFilters\\Mandatory'
      ],
      'accessControlFilterResolverClassName' => 'Espo\\Core\\Select\\AccessControl\\FilterResolvers\\Boolean'
    ],
    'PipelineStage' => [
      'accessControlFilterClassNameMap' => [
        'mandatory' => 'Espo\\Classes\\Select\\PipelineStage\\AccessControlFilters\\Mandatory'
      ],
      'accessControlFilterResolverClassName' => 'Espo\\Core\\Select\\AccessControl\\FilterResolvers\\Boolean',
      'ordererClassNameMap' => [
        'listOrder' => 'Espo\\Classes\\Select\\PipelineStage\\ListOrderOrderer'
      ]
    ],
    'ScheduledJob' => [
      'accessControlFilterClassNameMap' => [
