  ...
  'Campaign' => [
    'attributes' => [
      ...
      'budgetConverted' => [
        'type' => 'float',
        'select' => [
          'select' => 'MUL:(budget, IF:(EQUAL:(budgetCurrency, \'USD\'), 1, IF:(EQUAL:(budgetCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))'
        ],
        'selectForeign' => [
          'select' => 'MUL:({alias}.budget, IF:(EQUAL:({alias}.budgetCurrency, \'USD\'), 1, IF:(EQUAL:({alias}.budgetCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))'
        ],
        'where' => [
          '=' => [
            'whereClause' => [
              'MUL:(budget, IF:(EQUAL:(budgetCurrency, \'USD\'), 1, IF:(EQUAL:(budgetCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))=' => '{value}'
            ]
          ],
          '>' => [
            'whereClause' => [
          ...
          'IS NULL' => [
            'whereClause' => [
              'MUL:(budget, IF:(EQUAL:(budgetCurrency, \'USD\'), 1, IF:(EQUAL:(budgetCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))=' => NULL
            ]
          ],
          'IS NOT NULL' => [
            'whereClause' => [
        ...
        'order' => [
          'order' => [
            0 => [
              0 => 'MUL:(budget, IF:(EQUAL:(budgetCurrency, \'USD\'), 1, IF:(EQUAL:(budgetCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))',
              1 => '{direction}'
            ]
          ]
        ],
  ...
  'Lead' => [
    'attributes' => [
      ...
      'opportunityAmountConverted' => [
        'type' => 'float',
        'select' => [
          'select' => 'MUL:(opportunityAmount, IF:(EQUAL:(opportunityAmountCurrency, \'USD\'), 1, IF:(EQUAL:(opportunityAmountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))'
        ],
        'selectForeign' => [
          'select' => 'MUL:({alias}.opportunityAmount, IF:(EQUAL:({alias}.opportunityAmountCurrency, \'USD\'), 1, IF:(EQUAL:({alias}.opportunityAmountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))'
        ],
        'where' => [
          '=' => [
            'whereClause' => [
              'MUL:(opportunityAmount, IF:(EQUAL:(opportunityAmountCurrency, \'USD\'), 1, IF:(EQUAL:(opportunityAmountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))=' => '{value}'
            ]
          ],
          '>' => [
            'whereClause' => [
          ...
          'IS NULL' => [
            'whereClause' => [
              'MUL:(opportunityAmount, IF:(EQUAL:(opportunityAmountCurrency, \'USD\'), 1, IF:(EQUAL:(opportunityAmountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))=' => NULL
            ]
          ],
          'IS NOT NULL' => [
            'whereClause' => [
        ...
        'order' => [
          'order' => [
            0 => [
              0 => 'MUL:(opportunityAmount, IF:(EQUAL:(opportunityAmountCurrency, \'USD\'), 1, IF:(EQUAL:(opportunityAmountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))',
              1 => '{direction}'
            ]
          ]
        ],
  ...
  'Opportunity' => [
    'attributes' => [
      ...
      'amountConverted' => [
        'type' => 'float',
        'select' => [
          'select' => 'MUL:(amount, IF:(EQUAL:(amountCurrency, \'USD\'), 1, IF:(EQUAL:(amountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))'
        ],
        'selectForeign' => [
          'select' => 'MUL:({alias}.amount, IF:(EQUAL:({alias}.amountCurrency, \'USD\'), 1, IF:(EQUAL:({alias}.amountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))'
        ],
        'where' => [
          '=' => [
            'whereClause' => [
              'MUL:(amount, IF:(EQUAL:(amountCurrency, \'USD\'), 1, IF:(EQUAL:(amountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))=' => '{value}'
            ]
          ],
          '>' => [
            'whereClause' => [
          ...
          'IS NULL' => [
            'whereClause' => [
              'MUL:(amount, IF:(EQUAL:(amountCurrency, \'USD\'), 1, IF:(EQUAL:(amountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))=' => NULL
            ]
          ],
          'IS NOT NULL' => [
            'whereClause' => [
        ...
        'order' => [
          'order' => [
            0 => [
              0 => 'MUL:(amount, IF:(EQUAL:(amountCurrency, \'USD\'), 1, IF:(EQUAL:(amountCurrency, \'USD\'), CURRENCY_RATE:(\'USD\'), 0)))',
              1 => '{direction}'
            ]
          ]
        ],
