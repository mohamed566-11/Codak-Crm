...
return [
  'Campaign' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\Campaign\\ValidateCampaignTypeDependencies',
        'order' => 9
      ]
    ]
  ],
  'Case' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\Case\\ValidateCaseNumberVisibility',
        'order' => 9
      ]
    ],
    'afterSave' => [
  ...
  'Contact' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\Contact\\ValidateTitleAccountDependency',
        'order' => 9
      ],
      1 => [
  ...
  'Lead' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\Lead\\RequireNameIfContactInfoEmpty',
        'order' => 9
      ],
      1 => [
  ...
  'Meeting' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\Meeting\\ValidateMeetingAllDayDuration',
        'order' => 9
      ],
      1 => [
  ...
  'Opportunity' => [
    'beforeSave' => [
      ...
      2 => [
        'className' => 'Espo\\Custom\\Hooks\\Opportunity\\ValidateStageLastStageDependency',
        'order' => 9
      ]
    ],
    'afterSave' => [
  ...
  'TargetList' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\TargetList\\ValidateTargetListCountVisibility',
        'order' => 9
      ]
    ]
  ],
  'Task' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Custom\\Hooks\\Task\\ValidateTaskDateCompletedVisibility',
        'order' => 9
      ],
      1 => [
  ...
  'Common' => [
    ...
    'beforeSave' => [
      ...
      1 => [
        'className' => 'Espo\\Hooks\\Common\\PipelineStageStatus',
        'order' => 1
      ],
      2 => [
      ...
      5 => [
        'className' => 'Espo\\Hooks\\Common\\PipelineStageValidation',
        'order' => 9
      ],
      6 => [
        'className' => 'Espo\\Hooks\\Common\\Stream',
      ...
      9 => [
        'className' => 'Espo\\Hooks\\Common\\ValidateLocked',
        'order' => 12
      ],
      10 => [
  ...
  'Note' => [
    'beforeSave' => [
      ...
      1 => [
        'className' => 'Espo\\Hooks\\Note\\SetFields',
        'order' => 9
      ]
    ],
    'afterSave' => [
  ...
  'Pipeline' => [
    'afterSave' => [
      0 => [
        'className' => 'Espo\\Hooks\\Pipeline\\CreateStages',
        'order' => 9
      ]
    ],
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Hooks\\Pipeline\\Order',
        'order' => 9
      ],
      1 => [
        'className' => 'Espo\\Hooks\\Pipeline\\SetFields',
        'order' => 9
      ]
    ],
    'afterRemove' => [
  ...
  'PipelineStage' => [
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Hooks\\PipelineStage\\Order',
        'order' => 9
      ]
    ],
    'afterRemove' => [
  ...
  'User' => [
    ...
    'beforeSave' => [
      0 => [
        'className' => 'Espo\\Hooks\\User\\IncrementPasswordVersion',
        'order' => 9
      ]
    ]
  ]
