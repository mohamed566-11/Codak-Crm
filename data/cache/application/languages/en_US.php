...
Are you sure?'
  ...
  'Admin' => [
    ...
    'fields' => [
      ...
      'dynamicLogicCascading' => 'Cascading select',
    ...
    'messages' => [
      'noPipelinesEnabled' => 'No entity types have pipelines enabled.',
      ...
      'upgradeVersion' => 'CodakCRM will be upgraded to version **{version}**. Please be patient as this may take a while.',
      'upgradeDone' => 'CodakCRM has been upgraded to version **{version}**.',
      'upgradeBackup' => 'We recommend making a backup of your CodakCRM files and data before upgrading.',
    ...
    'descriptions' => [
      ...
      'pipelines' => 'Configure multiple pipelines.'
    ],
    'keywords' => [
      'settings' => 'system',
...
It will be removed for other users too.',
  ...
  'EmailAccount' => [
    ...
    'messages' => [
      'resetFetchData' => 'Emails will be re-fetched starting from the specified date. Existing emails will not be duplicated.',
...
{optOutLink} &#8211; an unsubscribe link.'
  ...
  'EntityManager' => [
    ...
    'messages' => [
      ...
      'cannotEnablePipelinesWithNoStatusField' => 'Pipelines cannot be enabled as the entity type does not have a status field. Create an Enum field for status if needed, then select it in the Status Field parameter.',
      'cannotEnableCategoriesWithKanbanViewMode' => 'Categories is not compatible with the Kanban view. Disable either one or another.'
    ],
    'tooltips' => [
      'pipelines' => 'Enables multiple pipelines. Pipelines can be configured at Administration > Pipelines.',
...
Validation: `{type}`',
    ...
    'links' => [
      ...
      'opportunity' => 'Opportunity',
      'contact' => 'Contact',
      'meetingsChildren' => 'Meetings Children',
      'callsChildren' => 'Calls Children'
    ],
    'dashlets' => [
      'Stream' => 'Stream',
      'Emails' => 'My Inbox',
...
Visit [Google Developers Console](https://console.developers.google.com/project) to obtain OAuth 2.0 credentials such as a Client ID and Client Secret that are known to both Google and CodakCRM application.',
  ...
  'Pipeline' => [
    ...
    'fields' => [
      ...
      'entityType' => 'Entity Type',
      'field' => 'Field',
      'isAvailableForAll' => 'Available for All',
      'color' => 'Color'
    ],
    'links' => [
      'stages' => 'Stages'
  ...
  'PipelineStage' => [
    'labels' => [
      'Create PipelineStage' => 'Create Stage'
    ],
    'fields' => [
      'order' => 'Order',
      'pipeline' => 'Pipeline',
...
Portals are not affected by restriction.',
      ...
      'siteUrl' => 'A URL of this CodakCRM instance. You need to change it if you move to another domain.',
...
- \'Principal\' - the form \'tester@company.com\'.',
      ...
      'b2cMode' => 'By default CodakCRM is adapted for B2B. You can switch it to B2C.',
...
**Important**. Changing this role affects all users – review the change carefully to avoid granting unintended permissions.'
  ...
  'Template' => [
    ...
    'tooltips' => [
      'body' => 'See the [documentation](https://docs.espocrm.com/user-guide/printing-to-pdf/#templates).

Use Code View for precise markup editing.
...
`Document_{{today}}_{{name}}`',
  ...
  'User' => [
    ...
    'messages' => [
      ...
      'ldapUserInEspoNotFound' => 'User is not found in CodakCRM. Contact your administrator to create the user.',
...
Leave the field empty if you need to apply the exception only for specific users.',
  ...
  'Meeting' => [
    ...
    'messages' => [
      ...
      'invitationsSentTo' => 'Invitation emails has been sent to: {recipients}.

Could not sent to: {failedRecipients}.'
    ]
  ],
  'Opportunity' => [
    'fields' => [
